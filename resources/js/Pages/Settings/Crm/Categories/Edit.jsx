...
export default function CrmCategoriesEdit({ crmCategory, listFilters = {} }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        form.patch(
            route('settings.crm.categories.update', crmCategory.id) + listQs,
        );
    };
        ...
        <WorkflowSettingsLayout moduleKey="categories"
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={
                            route('settings.crm.categories.index') + listQs
                        }

...
const FLASH_MESSAGES = {
    'crm-category-created': 'Category created.',
    'crm-category-updated': 'Category updated.',
    'crm-category-archived': 'Category moved to archive.',
};

export default function CrmCategoriesIndex({ crmCategories, filters = {} }) {
    const rows = crmCategories?.data ?? [];
    ...
    const confirmArchive = useCallback(() => {
        ...
        router.delete(
            route('settings.crm.categories.destroy', archiveTarget.id) + qs,
            { preserveScroll: true },
        );
    ...
    return (
        <WorkflowSettingsLayout moduleKey="categories"
            header={
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <Link
                            href={route('settings.crm.categories.create')}
                        ...
                        <Link
                            href={
                                route('settings.crm.categories.archive') +
            ...
            <div className="space-y-4">
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.crm.categories.index"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}
                    ...
                    />
                    <Pagination pagination={crmCategories} />
                </div>
            </div>

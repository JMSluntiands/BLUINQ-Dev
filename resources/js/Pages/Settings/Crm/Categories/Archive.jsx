...
const FLASH_MESSAGES = {
    'crm-category-restored': 'Category restored to the list.',
};

export default function CrmCategoriesArchive({ crmCategories, filters = {} }) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route('settings.crm.categories.restore', restoreTarget.id) + q,
            {},
            { preserveScroll: true },
        );
        ...
        <WorkflowSettingsLayout moduleKey="categories"
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={
                            route('settings.crm.categories.index') +
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.crm.categories.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

...
export default function ArrivalInputFilesEdit({
    arrivalInputFile,
    listFilters = {},
}) {
    ...
    const form = useForm({
        name: arrivalInputFile.name,
        status: arrivalInputFile.status,
    });
    ...
    const submit = (e) => {
        ...
        form.patch(
            route(
                'settings.crm.arrival-input-files.update',
                arrivalInputFile.id,
            ) + listQs,
        );
    };
    ...
    return (
        ...
        >
            <Head title="Arrival input files — Edit" />

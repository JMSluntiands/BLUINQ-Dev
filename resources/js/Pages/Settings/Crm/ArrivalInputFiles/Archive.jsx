...
const FLASH_MESSAGES = {
    'arrival-input-file-restored':
        'Arrival input file restored to the list.',
};

export default function ArrivalInputFilesArchive({
    arrivalInputFiles,
    filters = {},
}) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route(
                'settings.crm.arrival-input-files.restore',
                restoreTarget.id,
            ) + q,
            {},
            { preserveScroll: true },
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-[#323338]">
                        Arrival input files — Archive
                    </h2>
                    <Link
                        href={
                            route('settings.crm.arrival-input-files.index') +
        ...
        >
            <Head title="Arrival input files — Archive" />
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.crm.arrival-input-files.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}
                        ...
                        emptyMessage={
                            hasSearch
                                ...
                                : 'No archived arrival input files.'
                        }
                    />

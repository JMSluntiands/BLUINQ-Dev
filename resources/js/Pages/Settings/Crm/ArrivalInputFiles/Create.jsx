...
export default function ArrivalInputFilesCreate() {
    const form = useForm({
        name: '',
        status: 'active',
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.crm.arrival-input-files.store'));
    };
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-slate-800">
                        Arrival input files — Create
                    </h2>
                    <Link
                        href={route('settings.crm.arrival-input-files.index')}
        ...
        >
            <Head title="Arrival input files — Create" />

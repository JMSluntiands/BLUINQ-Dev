...
export default function DeliverablesCreate() {
    const form = useForm({
        name: '',
        status: 'active',
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.deliverables.store'));
    };
    ...
    return (
        <WorkflowSettingsLayout moduleKey="deliverables"
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={route('settings.deliverables.index')}
        ...
        >
            <Head title="Deliverables — Create" />

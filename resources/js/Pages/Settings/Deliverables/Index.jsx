...
const FLASH_MESSAGES = {
    'deliverables-created': 'Deliverable created.',
    'deliverables-updated': 'Deliverable updated.',
    'deliverables-archived': 'Deliverable moved to archive.',
};

export default function DeliverablesIndex({ deliverables, filters = {} }) {
    ...
    const confirmArchive = useCallback(() => {
        ...
        router.delete(
            route('settings.deliverables.destroy', archiveTarget.id) + qs,
            { preserveScroll: true },
        );
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className="flex flex-wrap items-center justify-end gap-0.5">
                            <Link
                                href={
                                    route('settings.deliverables.edit', r.id) + q
                                }
                                className={iconBtn}
                                title="Edit"
            ...
            header={
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <Link
                            href={route('settings.deliverables.create')}
                        ...
                        <Link
                            href={
                                route('settings.deliverables.archive') +
            ...
            <div className="space-y-4">
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.deliverables.index"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

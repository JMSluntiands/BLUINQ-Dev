...
export default function ServiceEngagingCreate() {
    const form = useForm({
        name: '',
        status: 'active',
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.service-engaging.store'));
    };
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-slate-800">
                        Service engaging — Create
                    </h2>
                    <Link
                        href={route('settings.service-engaging.index')}
        ...
        >
            <Head title="Service engaging — Create" />

...
const FLASH_MESSAGES = {
    'service-engaging-restored': 'Service engaging restored to the list.',
};

export default function ServiceEngagingArchive({
    serviceEngagings,
    filters = {},
}) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route('settings.service-engaging.restore', restoreTarget.id) + q,
            {},
            { preserveScroll: true },
        );
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-[#323338]">
                        Service engaging — Archive
                    </h2>
                    <Link
                        href={
                            route('settings.service-engaging.index') +
        ...
        >
            <Head title="Service engaging — Archive" />
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.service-engaging.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}
                        ...
                        emptyMessage={
                            hasSearch
                                ...
                                : 'No archived service engaging entries.'
                        }
                    />

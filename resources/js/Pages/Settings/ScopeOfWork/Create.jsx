...
export default function ScopeOfWorkCreate() {
    const form = useForm({
        name: '',
        status: 'active',
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.scope-of-work.store'));
    };
    ...
    return (
        <WorkflowSettingsLayout moduleKey="scope-of-work"
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={route('settings.scope-of-work.index')}
        ...
        >
            <Head title="Scope of work — Create" />

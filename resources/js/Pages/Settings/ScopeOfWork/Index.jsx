...
const FLASH_MESSAGES = {
    'scope-of-work-created': 'Scope of work created.',
    'scope-of-work-updated': 'Scope of work updated.',
    'scope-of-work-archived': 'Scope of work moved to archive.',
};

export default function ScopeOfWorkIndex({ scopeOfWorks, filters = {} }) {
    const rows = scopeOfWorks?.data ?? [];
    ...
    const confirmArchive = useCallback(() => {
        ...
        router.delete(
            route('settings.scope-of-work.destroy', archiveTarget.id) + qs,
            { preserveScroll: true },
        );
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className="flex flex-wrap items-center justify-end gap-0.5">
                            <Link
                                href={
                                    route('settings.scope-of-work.edit', r.id) +
                                    q
                                }
                                className={iconBtn}
                                title="Edit"
            ...
            header={
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <Link
                            href={route('settings.scope-of-work.create')}
                        ...
                        <Link
                            href={
                                route('settings.scope-of-work.archive') +
            ...
            <div className="space-y-4">
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.scope-of-work.index"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}
                        ...
                        emptyMessage={
                            hasSearch
                                ...
                                : 'No scopes yet. Add one to get started.'
                        }
                    />

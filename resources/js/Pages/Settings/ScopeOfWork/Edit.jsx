...
export default function ScopeOfWorkEdit({ scopeOfWork, listFilters = {} }) {
    const listQs = filterQueryString(listFilters);

    const form = useForm({
        name: scopeOfWork.name,
    ...
    const submit = (e) => {
        e.preventDefault();
        form.patch(
            route('settings.scope-of-work.update', scopeOfWork.id) + listQs,
        );
    };
        ...
        <WorkflowSettingsLayout moduleKey="scope-of-work"
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={route('settings.scope-of-work.index') + listQs}
            ...
            <div className="max-w-xl rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link
                            href={
                                route('settings.scope-of-work.index') + listQs
                            }

...
const FLASH_MESSAGES = {
    'scope-of-work-restored': 'Scope of work restored to the list.',
};

export default function ScopeOfWorkArchive({ scopeOfWorks, filters = {} }) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route('settings.scope-of-work.restore', restoreTarget.id) + q,
            {},
            { preserveScroll: true },
        );
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-[#323338]">
                        Scope of work — Archive
                    </h2>
                    <Link
                        href={
                            route('settings.scope-of-work.index') +
        ...
        >
            <Head title="Scope of work — Archive" />
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.scope-of-work.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

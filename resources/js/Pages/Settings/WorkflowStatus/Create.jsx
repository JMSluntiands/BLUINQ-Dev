...
export default function WorkflowStatusCreate({ kindOptions = {} }) {
    const form = useForm({
        kind: 'archi',
        code: '',
        name: '',
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.workflow-status.store'));
    };
        ...
        <WorkflowSettingsLayout
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={route('settings.workflow-status.index')}

...
const FLASH_MESSAGES = {
    'workflow-status-restored': 'Status restored to the list.',
};

export default function WorkflowStatusArchive({
    workflowStatuses,
    filters = {},
    kindOptions = {},
}) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route('settings.workflow-status.restore', restoreTarget.id) + q,
            {},
            { preserveScroll: true },
        );
        ...
        <WorkflowSettingsLayout
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={
                            route('settings.workflow-status.index') +
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.workflow-status.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

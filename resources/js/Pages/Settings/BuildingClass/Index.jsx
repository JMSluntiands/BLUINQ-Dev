...
const FLASH_MESSAGES = {
    'building-class-created': 'Building class created.',
    'building-class-updated': 'Building class updated.',
    'building-class-archived': 'Building class moved to archive.',
};

export default function BuildingClassIndex({ buildingClasses, filters = {} }) {
    const rows = buildingClasses?.data ?? [];
    ...
    const confirmArchive = useCallback(() => {
        ...
        router.delete(
            route('settings.building-class.destroy', archiveTarget.id) + qs,
            { preserveScroll: true },
        );
    ...
    return (
        <WorkflowSettingsLayout moduleKey="building-class"
            header={
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <Link
                            href={
                                route('settings.building-class.archive') +
        ...
        >
            <Head title="Building class — List" />
            ...
            <div className="space-y-4">
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.building-class.index"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

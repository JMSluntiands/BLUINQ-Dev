...
const FLASH_MESSAGES = {
    'building-class-restored': 'Building class restored to the list.',
};

export default function BuildingClassArchive({ buildingClasses, filters = {} }) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route('settings.building-class.restore', restoreTarget.id) + q,
            {},
            { preserveScroll: true },
        );
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-[#323338]">
                        Building class — Archive
                    </h2>
                    <Link
                        href={
                            route('settings.building-class.index') +
        ...
        >
            <Head title="Building class — Archive" />
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.building-class.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

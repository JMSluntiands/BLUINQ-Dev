...
export default function BuildingClassCreate() {
    const form = useForm({
        code: '',
        name: '',
        status: 'active',
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.building-class.store'));
    };
    ...
    return (
        <WorkflowSettingsLayout moduleKey="building-class"
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={route('settings.building-class.index')}
        ...
        >
            <Head title="Building class — Create" />

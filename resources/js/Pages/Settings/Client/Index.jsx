...
export default function ClientIndex({ clients, filters = {} }) {
    ...
    const confirmArchive = useCallback(() => {
        ...
        router.delete(
            route('settings.client.destroy', archiveTarget.id) + qs,
            { preserveScroll: true },
        );
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className="flex flex-wrap items-center justify-end gap-0.5">
                            <Link
                                href={
                                    route('settings.client.edit', r.id) + q
                                }
                                className={iconBtn}
                                title="Edit"
            ...
            header={
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <Link
                            href={route('settings.client.create')}
            ...
            >
                <div className="p-6">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-[#676879]">
                        ...
                        will move to Archive and can be restored later. Inactive
                        clients also stay hidden from the masterlist form.
                    </p>
            ...
            <div className="space-y-4">
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.client.index"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

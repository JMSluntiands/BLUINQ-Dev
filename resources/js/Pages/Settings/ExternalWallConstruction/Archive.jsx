...
const FLASH_MESSAGES = {
    'external-wall-construction-restored':
        'External wall construction restored to the list.',
};

export default function ExternalWallConstructionArchive({
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route(
                'settings.external-wall-construction.restore',
                restoreTarget.id,
            ) + q,
            {},
            { preserveScroll: true },
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-[#323338]">
                        External wall construction — Archive
                    </h2>
                    <Link
                        href={
                            route('settings.external-wall-construction.index') +
        ...
        >
            <Head title="External wall construction — Archive" />
            ...
            >
                <div className="p-6">
                    <h2 className="text-lg font-semibold text-[#323338]">
                        Restore external wall construction?
                    </h2>
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.external-wall-construction.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}
                        ...
                        emptyMessage={
                            hasSearch
                                ...
                                : 'No archived external wall construction entries.'
                        }
                    />

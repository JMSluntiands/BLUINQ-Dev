...
const FLASH_MESSAGES = {
    'external-wall-construction-created': 'External wall construction created.',
    'external-wall-construction-updated': 'External wall construction updated.',
    'external-wall-construction-archived':
        'External wall construction moved to archive.',
};

export default function ExternalWallConstructionIndex({
    externalWallConstructions,
    filters = {},
}) {
    const rows = externalWallConstructions?.data ?? [];
    ...
    const confirmArchive = useCallback(() => {
        ...
        router.delete(
            route(
                'settings.external-wall-construction.destroy',
                archiveTarget.id,
            ) + qs,
            { preserveScroll: true },
        );
                    ...
                    return (
                        <div className="flex flex-wrap items-center justify-end gap-0.5">
                            <Link
                                href={
                                    route(
                                        'settings.external-wall-construction.edit',
                                        r.id,
                                    ) + q
                                }
                                className={iconBtn}
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-[#323338]">
                        External wall construction — List
                    </h2>
                    <div className="flex flex-wrap gap-2">
                        <Link
                            href={route('settings.external-wall-construction.create')}
                        ...
                        >
                            Add external wall construction
                        </Link>
                        <Link
                            href={
                                route('settings.external-wall-construction.archive') +
        ...
        >
            <Head title="External wall construction — List" />
            ...
            >
                <div className="p-6">
                    <h2 className="text-lg font-semibold text-[#323338]">
                        Archive external wall construction?
                    </h2>
            ...
            <div className="space-y-4">
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.external-wall-construction.index"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}
                        ...
                        emptyMessage={
                            hasSearch
                                ? 'No external wall construction entries match your search.'
                                : 'No external wall construction entries yet. Add one to get started.'
                        }
                    />

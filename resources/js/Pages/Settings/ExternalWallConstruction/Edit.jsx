...
export default function ExternalWallConstructionEdit({
    ...
    const form = useForm({
        name: externalWallConstruction.name,
        status: externalWallConstruction.status,
    });
    ...
    const submit = (e) => {
        ...
        form.patch(
            route(
                'settings.external-wall-construction.update',
                externalWallConstruction.id,
            ) + listQs,
        );
    };
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-slate-800">
                        External wall construction — Edit
                    </h2>
                    <Link
                        href={
        ...
        >
            <Head title="External wall construction — Edit" />

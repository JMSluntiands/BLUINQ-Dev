...
const FLASH_MESSAGES = {
    'roof-type-created': 'Roof type created.',
    'roof-type-updated': 'Roof type updated.',
    'roof-type-archived': 'Roof type moved to archive.',
};

export default function RoofTypeIndex({ roofTypes, filters = {} }) {
    const rows = roofTypes?.data ?? [];
    ...
    const confirmArchive = useCallback(() => {
        ...
        router.delete(route('settings.roof-type.destroy', archiveTarget.id) + qs, {
            preserveScroll: true,
        });
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className="flex flex-wrap items-center justify-end gap-0.5">
                            <Link
                                href={
                                    route('settings.roof-type.edit', r.id) + q
                                }
                                className={iconBtn}
                                title="Edit"
            ...
            header={
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <Link
                            href={route('settings.roof-type.create')}
                        ...
                        <Link
                            href={
                                route('settings.roof-type.archive') +
            ...
            <div className="space-y-4">
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.roof-type.index"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}
                        ...
                        emptyMessage={
                            hasSearch
                                ? 'No roof types match your search.'
                                : 'No roof types yet. Add one to get started.'
                        }
                    />

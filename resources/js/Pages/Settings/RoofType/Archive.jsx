...
const FLASH_MESSAGES = {
    'roof-type-restored': 'Roof type restored to the list.',
};

export default function RoofTypeArchive({ roofTypes, filters = {} }) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route('settings.roof-type.restore', restoreTarget.id) + q,
            {},
            { preserveScroll: true },
        );
        ...
        <AuthenticatedLayout
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={route('settings.roof-type.index') + filterQueryString(filters)}
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.roof-type.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

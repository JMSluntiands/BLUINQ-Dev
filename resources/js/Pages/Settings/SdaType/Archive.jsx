...
const FLASH_MESSAGES = {
    'sda-type-restored': 'SDA type restored to the list.',
};

export default function SdaTypeArchive({ sdaTypes, filters = {} }) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route('settings.sda-type.restore', restoreTarget.id) + q,
            {},
            { preserveScroll: true },
        );
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.sda-type.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

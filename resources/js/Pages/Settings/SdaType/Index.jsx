...
const FLASH_MESSAGES = {
    'sda-type-created': 'SDA type created.',
    'sda-type-updated': 'SDA type updated.',
    'sda-type-archived': 'SDA type moved to archive.',
};

export default function SdaTypeIndex({ sdaTypes, filters = {} }) {
    const rows = sdaTypes?.data ?? [];
    ...
    const confirmArchive = useCallback(() => {
        ...
        router.delete(
            route('settings.sda-type.destroy', archiveTarget.id) + qs,
            { preserveScroll: true },
        );
    ...
    return (
        <WorkflowSettingsLayout moduleKey="sda-type"
            header={
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <Link
                            href={
                                route('settings.sda-type.archive') +
            ...
            <div className="space-y-4">
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.sda-type.index"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

...
const FLASH_MESSAGES = {
    'level-of-difficulty-restored':
        'Level of difficulty restored to the list.',
};

export default function LevelOfDifficultyArchive({
    levelOfDifficulties,
    filters = {},
}) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route(
                'settings.level-of-difficulty.restore',
                restoreTarget.id,
            ) + q,
            {},
            { preserveScroll: true },
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-[#323338]">
                        Level of difficulty — Archive
                    </h2>
                    <Link
                        href={
                            route('settings.level-of-difficulty.index') +
        ...
        >
            <Head title="Level of difficulty — Archive" />
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.level-of-difficulty.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}
                        ...
                        emptyMessage={
                            hasSearch
                                ...
                                : 'No archived levels of difficulty.'
                        }
                    />

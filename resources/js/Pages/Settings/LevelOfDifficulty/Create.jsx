...
export default function LevelOfDifficultyCreate() {
    const form = useForm({
        name: '',
        status: 'active',
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.level-of-difficulty.store'));
    };
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-slate-800">
                        Level of difficulty — Create
                    </h2>
                    <Link
                        href={route('settings.level-of-difficulty.index')}
        ...
        >
            <Head title="Level of difficulty — Create" />

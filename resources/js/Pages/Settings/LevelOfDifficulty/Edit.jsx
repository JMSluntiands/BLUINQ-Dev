...
export default function LevelOfDifficultyEdit({
    levelOfDifficulty,
    listFilters = {},
}) {
    ...
    const form = useForm({
        ...
        status: levelOfDifficulty.status,
    });
    ...
    const submit = (e) => {
        ...
        form.patch(
            route(
                'settings.level-of-difficulty.update',
                levelOfDifficulty.id,
            ) + listQs,
        );
    };
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-slate-800">
                        Level of difficulty — Edit
                    </h2>
                    <Link
                        href={
                            route('settings.level-of-difficulty.index') + listQs
                        }
        ...
        >
            <Head title="Level of difficulty — Edit" />

...
const FLASH_MESSAGES = {
    'building-type-restored': 'Building type restored to the list.',
};

export default function BuildingTypeArchive({ buildingTypes, filters = {} }) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route('settings.building-type.restore', restoreTarget.id) + q,
            {},
            { preserveScroll: true },
        );
    ...
    return (
        <AuthenticatedLayout
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={
                            route('settings.building-type.index') +
        ...
        >
            <Head title="Building type — Archive" />
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.building-type.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

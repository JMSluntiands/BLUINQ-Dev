...
export default function BuildingTypeEdit({ buildingType, listFilters = {} }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        form.patch(
            route('settings.building-type.update', buildingType.id) +
                listQs,
        );
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={
                            route('settings.building-type.index') + listQs
                        }

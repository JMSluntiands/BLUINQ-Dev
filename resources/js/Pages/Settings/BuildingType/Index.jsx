...
const FLASH_MESSAGES = {
    'building-type-created': 'Building type created.',
    'building-type-updated': 'Building type updated.',
    'building-type-archived': 'Building type moved to archive.',
};

export default function BuildingTypeIndex({ buildingTypes, filters = {} }) {
    const rows = buildingTypes?.data ?? [];
    ...
    const confirmArchive = useCallback(() => {
        ...
        router.delete(
            route('settings.building-type.destroy', archiveTarget.id) + qs,
            { preserveScroll: true },
        );
            ...
            header={
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <Link
                            href={route('settings.building-type.create')}
                        ...
                        <Link
                            href={
                                route('settings.building-type.archive') +
            ...
            <div className="space-y-4">
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.building-type.index"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}
                        ...
                        emptyMessage={
                            hasSearch
                                ? 'No building types match your search.'
                                : 'No building types yet. Add one to get started.'
                        }
                    />

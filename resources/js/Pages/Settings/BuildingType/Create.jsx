...
export default function BuildingTypeCreate() {
    const form = useForm({
        name: '',
        status: 'active',
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.building-type.store'));
    };
    ...
    return (
        <WorkflowSettingsLayout moduleKey="building-type"
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        href={route('settings.building-type.index')}
        ...
        >
            <Head title="Building type — Create" />

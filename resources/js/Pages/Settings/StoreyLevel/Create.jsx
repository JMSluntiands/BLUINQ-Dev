...
export default function StoreyLevelCreate() {
    const form = useForm({
        code: '',
        name: '',
        status: 'active',
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('settings.storey-level.store'));
    };
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-slate-800">
                        Typical storeys & levels — Create
                    </h2>
                    <Link
                        href={route('settings.storey-level.index')}
        ...
        >
            <Head title="Typical storeys & levels — Create" />

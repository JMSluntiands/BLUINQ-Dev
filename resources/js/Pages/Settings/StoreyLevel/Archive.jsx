...
const FLASH_MESSAGES = {
    'storey-level-restored': 'Typical storey & level restored to the list.',
};

export default function StoreyLevelArchive({ storeyLevels, filters = {} }) {
    ...
    const confirmRestore = useCallback(() => {
        ...
        router.post(
            route('settings.storey-level.restore', restoreTarget.id) + q,
            {},
            { preserveScroll: true },
        );
    ...
    return (
            ...
            header={
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-[#323338]">
                        Typical storeys & levels — Archive
                    </h2>
                    <Link
                        href={
                            route('settings.storey-level.index') +
        ...
        >
            <Head title="Typical storeys & levels — Archive" />
            ...
            <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#e6e9ef] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
                    <TableSearchToolbar
                        ...
                        ziggyRouteName="settings.storey-level.archive"
                        filters={filters}
                    />
                    <DataTable
                        data={rows}

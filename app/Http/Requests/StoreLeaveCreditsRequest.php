...
class StoreLeaveCreditsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'amount' => ['required', 'numeric', 'min:0.01', 'max:365', 'decimal:0,2'],
    ...
    public function messages(): array
    {
        return [
            ...
            'amount.min' => 'Credits must be at least 0.01.',
            'amount.decimal' => 'Credits must use up to two decimal places (e.g. 0.25).',
